	...
	def run(self):
		if sublime.ok_cancel_dialog("Are you sure you want to upgrade Code4Brownies to the latest version?", "Yes"):
			...
			try:
				...
				sublime.message_dialog("Code4Brownies has been upgraded to version %s.  You might need to get the latest server at https://github.com/vtphan/Code4Brownies" % version)
			except:
